...
@section('content')
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1 class="mb-2">Incoming Referrals </h1>
            <nav>
                <ol class="breadcrumb">
                                ...
                                <tr>
                                    ...
                                    <td class="no-click">
                                        <div class="btn-group" role="group">
                                            <button
                                                onclick="window.location.href='{{ route('referrals.viewIncomingReferral', $referralRequest) }}'"
                                                type="button" class="btn btn-primary" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                View
                                            </button>
                                        </div>
