...
@section('content')
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Incoming Referrals Report</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Reports</a></li>
                    <li class="breadcrumb-item active">Incoming Referrals Report</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Incoming Referrals</h5>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="7" class="text-center">No incoming referrals found.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
