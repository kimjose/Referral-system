...
@section('form')
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1 class="mb-2">Generalised Anxiety Disorder(GAD-7) Form</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Patient</a></li>
                    <li class="breadcrumb-item active">GAD-7 Assessment</li>
                </ol>
            </nav>
        </div>
                ...
                <form id="phq9" method="post" action="{{ route('gad7.storeGad7') }}">
                    ...
                    <div class="row mb-3">
                        <div class="field pt-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="anxious_nervous" class="form-label">Feeling nervous, anxious, or on
                                        edge</label>
                                ...
                                <div class="col-md-6">
                                    <label for="uncontrollable_worrying" class="form-label">Not being able to stop or
                                        control
                                        worrying</label>
                                    <select class="form-control selected2" id="uncontrollable_worrying"
                                        name="uncontrollable_worrying">
                                        <option selected disabled style="text-align: center !important;">-- Select Option --
                                        </option>
                                        @foreach($assessmentScores as $assessmentScore)
                                            <option value="{{$assessmentScore['value']}}">{{$assessmentScore['name']}}</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label for="worrying_too_much" class="form-label">Worrying too much about different
                                        things</label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label for="restless" class="form-label">Being so restless that it is hard to sit
                                        still</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control selected2" id="irritable" name="irritable">
                                        <option selected disabled style="text-align: center !important;">-- Select Option --
                                        </option>
                                        @foreach($assessmentScores as $assessmentScore)
                                            <option value="{{$assessmentScore['value']}}">{{$assessmentScore['name']}}</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label for="afraid" class="form-label">Feeling afraid, as if something awful might
                                        happen</label>
                                    <select class="form-control selected2" id="afraid" name="afraid">
                                        <option selected disabled style="text-align: center !important;">-- Select Option --
                                        </option>
                                        @foreach($assessmentScores as $assessmentScore)
                                            <option value="{{$assessmentScore['value']}}">{{$assessmentScore['name']}}</option>
