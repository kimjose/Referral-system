    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">PTSD5</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="container py-5">
        <div class="card">
            <div class="card-body p-4">
                <div class="pagetitle">
                    <h1 class="text-center mb-5">PC PTSD-5: Post Traumatic stress disorder</h1>
                </div>
                ...
                <form id="phq9" method="post" action="{{ route('gad7.storeGad7') }}">
                    ...
                    <div id="divTrauma" class="d-none">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="nightmares" class="form-label">had nightmares about the event(s) or thought
                            ...
                            <div class="col-md-6">
                                <label for="hard_not_to_think" class="form-label">tried hard not to think about the
                                    ...
                                    event(s)?</label>
                                <select class="form-control selected2" id="hard_not_to_think" name="hard_not_to_think">
                                    <option selected disabled style="text-align: center !important;">-- Select Option --
                                    </option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="on_guard" class="form-label">been constantly on guard, watchful, or easily
                                    startled?</label>
                            ...
                            <div class="col-md-6">
                                <label for="felt_numb" class="form-label">felt numb or detached from people, activities,
