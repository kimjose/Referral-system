                            ...
                            <div class="field pt-3">
                                    ...
                                    <div class="col-md-4 pb-3 gap-2">
                                        ...
                                        <select class="form-control selected2" name="name" id="name">
                                            ...
                                            @foreach($patients as $patient)
                                                <option value="{{$patient}}">{{$patient->idNo}} -
                                ...
                                <div class="row">
                                    <div class="col-md-6 pb-3 gap-2">
                                        ...
                                        <input type="text" class="form-control" id="oxygen-saturation"
                                            name="oxygen_saturation" required>
                                    </div>
                                    <div class="col-md-6 pb-3 gap-2">
                                        <label for="pain-level" class="form-label">Pain Level:</label>
                                        <input type="number" class="form-control" id="pain-level" name="pain_level" min="1"
                                            max="10" required>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pb-3 gap-2">
                                        ...
                                        <input type="text" class="form-control" id="recent-travel" name="recent_travel"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 pb-3 gap-2">
                                        <label for="emergency-contact-name" class="form-label">Emergency Contact Name:
                                        </label>
                                        <input type="text" class="form-control" id="emergency-contact-name"
                                            name="emergency_contact_name" required>
                                    </div>
                                    <div class="col-md-6 pb-3 gap-2">
                                        <label for="emergency-contact-phone" class="form-label">Emergency Contact
                                            Phone:</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6 pb-3 gap-2">
                                        <label for="emergency-contact-relation" class="form-label">Emergency Contact
                                            Relation:</label>
                                        <input type="text" class="form-control" id="emergency-contact-relation"
